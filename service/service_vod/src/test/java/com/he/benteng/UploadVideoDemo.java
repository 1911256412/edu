...
public class UploadVideoDemo {
    ...
    public static void main(String[] args) {
        ...
        // 任何上传方式文件名必须包含扩展名
        String fileName = "D:/Java视频/java知识点/谷粒学院资料/项目资料/1-阿里云上传测试视频/6 - What If I Want to Move Faster.mp4";
        // 本地文件上传
        testUploadVideo("LTAI5t8p3xfzfbkEQi9aDvmj", "3BGcg5AU0S9qnIA2kYNwhPUIKJzxqw", title, fileName);
